...
SRC_URI = "git://github.com/BlackPole/bp-enigma2.git;protocol=git;branch=${ENIGMA2_BRANCH}"
...
do_blackpole_preinstall() {
	ln -f ${S}/data/${RADIOMVI} ${S}/data/radio.mvi
	install -d ${D}${sysconfdir}/enigma2
}

addtask blackpole_preinstall after do_compile before do_install

do_blackpole_branding() {
...
addtask blackpole_branding after do_unpack before do_configure
